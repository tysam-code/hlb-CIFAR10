...
class OptSched:
    def __init__(self, batchsize, net, total_train_steps, num_low_lr_steps_for_ema) -> None:
        ...
        self.opt = torch.optim.SGD(net.parameters(), lr=0.0005, weight_decay=1e-5)
        self.lr_sched = torch.optim.lr_scheduler.LinearLR(self.opt, start_factor=1.0, end_factor=0.8, total_iters=10)
